$(document).ready(function() { 
  ...
  $(".Month").change(function() {
    if ($(".Month:checked").length == $(".Month").length) {
      ...
      $("#map_cleanups").replaceWith("<iframe id='map_cleanups' src='" + baseLink + "' class='map'></iframe>")
    }
  });
